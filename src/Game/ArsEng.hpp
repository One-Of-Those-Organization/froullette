...
public:
  ...
  void update(float dt) {
    ...
    this->bigcanvas_cursor.x =
        (this->cursor.x / this->window_size.x) * this->bigcanvas.texture.width;
    this->bigcanvas_cursor.y =
        (this->cursor.y / this->window_size.y) * this->bigcanvas.texture.height;
